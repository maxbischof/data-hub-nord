...
it("renders correctly", () => {
  ...
  const tree = renderer.create(<Router><DataList datasets={datasets} setRef={returnRef} /></Router>)
...
it("returns ref", async () => {
  ...
  const { container }  = render(<Router><DataList datasets={datasets} setRef={returnRef} /></Router>)
